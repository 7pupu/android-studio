...
*/
    ...
    private void btn_edittext() {
        btn = findViewById(R.id.button8);
        btn.setOnClickListener(new Button.OnClickListener() {public void onClick(View v){  //}});

            Intent intent = new Intent();
            intent.setClass(MainActivity.this  , Activity180810.class);
            startActivity(intent);
        }});
    }

    private void btn_color() {
        btn = findViewById(R.id.button6);
        btn.setOnClickListener(new Button.OnClickListener() {public void onClick(View v){  //}});

            Intent intent = new Intent();
            intent.setClass(MainActivity.this  , Main3Color.class);
            startActivity(intent);
        }});
    }
